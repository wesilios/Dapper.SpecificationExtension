...
public class MySqlSpecificationTests : SpecificationIntegrationTestBase<MySqlDatabaseFixture>
{
    ...
    public async Task Product_QueryBySpecAsync_WithDistinct_ShouldReturn_UniqueResults()
    {
        ...
        // Act
        var results = (await Connection.QueryBySpecAsync(specification, SqlDialect.MySql)).ToList();
    ...
    public async Task Product_QueryBySpecAsync_WithUnion_ShouldReturn_CombinedResults()
    {
        ...
        // Act
        var results = (await Connection.QueryBySpecAsync(spec1, SqlDialect.MySql)).ToList();
    ...
    public async Task Product_QueryBySpecAsync_WithCTE_ShouldReturn_ExpectedResults()
    {
        ...
        // Act
        var results = (await Connection.QueryBySpecAsync(spec, SqlDialect.MySql)).ToList();
