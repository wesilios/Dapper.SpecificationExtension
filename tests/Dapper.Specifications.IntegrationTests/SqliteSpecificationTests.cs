...
public class SqliteSpecificationTests : SpecificationIntegrationTestBase<SqliteDatabaseFixture>
{
    ...
    public async Task Product_QueryBySpecAsync_WithGroupByAndHaving_ShouldReturn_ExpectedResults()
    {
        ...
        // Act - Using raw query to test GROUP BY and HAVING
    ...
    public async Task Product_QueryBySpecAsync_WithDistinct_ShouldReturn_UniqueResults()
    {
        ...
        // Act
        var results = (await Connection.QueryBySpecAsync(specification, SqlDialect.Sqlite)).ToList();
    ...
    public async Task Product_QueryBySpecAsync_WithUnion_ShouldReturn_CombinedResults()
    {
        ...
        // Act
        var results = (await Connection.QueryBySpecAsync(spec1, SqlDialect.Sqlite)).ToList();
    ...
    public async Task Product_QueryBySpecAsync_WithCTE_ShouldReturn_ExpectedResults()
    {
        ...
        // Act
        var results = (await Connection.QueryBySpecAsync(spec, SqlDialect.Sqlite)).ToList();
